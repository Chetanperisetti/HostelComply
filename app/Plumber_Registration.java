    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(Plumber_Registration.this);
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance().getReference("Plumber")
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(Plumber_Registration.this);
                                                                    ...
                                                                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(Plumber_Registration.this, PlumberVerifyPhone.class);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(Plumber_Registration.this,"Error",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
...
//
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Plumber_Registration.this,Plumber_Login.class));
                finish();
            }
        });
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Plumber_Registration.this,Plumber_Loginphone.class));
                finish();
            }
        });

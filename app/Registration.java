...
public class Registration extends AppCompatActivity{
    ...
    String fname,lname,roomnumber,emailid,password,confpassword,mobile;
    String role="Student";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Roomnumber=(TextInputLayout)findViewById(R.id.Room);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                roomnumber=Roomnumber.getEditText().getText().toString().trim();
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        hashMap1.put("Roomnumber",roomnumber);
...
//
    ...
    String emailpattern = "[a-zA-Z0-9._-]+@[a-zA-Z0-9]+\\.ac\\.in";

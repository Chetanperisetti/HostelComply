...
public class OneComplaintStudentDisplayp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_complaint_student_displayp);

        databaseReference = FirebaseDatabase.getInstance().getReference("StudentplumbingComplaintDetailswithdate");
        dr = FirebaseDatabase.getInstance().getReference("StudentPlumbingComplaintDetails");
        ...
        if (extras != null) {
            ...
            TextView washroomnumberTextView=findViewById(R.id.washroomnumberTextView);
            ...
            washroomnumberTextView.setText(washroomNumber);
